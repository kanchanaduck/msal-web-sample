...
public class AuthPageController {
    ...
    public ModelAndView securePage(HttpServletRequest httpRequest) throws ParseException {
        ...
        course.add(new Course("Programming", "NET, Java, Python, Javascript"));
        course.add(new Course("Dev-Method", "Agile, Waterfall"));
        course.add(new Course("Test tool", "JUnit5, Mocha, PyTest"));
        course.add(new Course("Infrastructure Code", "Terraform, Ansible, Chef, Puppet"));
        course.add(new Course("Cloud Computing", "Azure, AWS, GCP"));
        course.add(new Course("Unix Admin", "Python, Bash, Perl"));

        ModelAndView mav = new ModelAndView("content");
        mav.addObject("courses", course);
        mav.addObject("c", "1234");
